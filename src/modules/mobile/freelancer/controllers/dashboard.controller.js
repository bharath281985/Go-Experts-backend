...
export const getDashboard = async (req, res, next) => {
    try {
        ...
        const [profile, wallet, subscription, todayTasksCount, upcomingMeetings, unreadNotifications, pendingProposals, acceptedProjects, completedProjects, currentContracts, reviews] = await Promise.all([
