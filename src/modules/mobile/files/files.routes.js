...
import { uploadFile, uploadMultiple, listFiles, getFile, previewFile, downloadFile, renameFile, deleteFile, restoreFile, listTrash, getStorageUsage } from './controllers/files.controller.js';
const router = Router();
