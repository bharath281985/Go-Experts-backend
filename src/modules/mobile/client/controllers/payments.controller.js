...
import { initiatePaymentService, verifyPaymentService, } from '../../payments/payments.service.js';
...
export const initiatePayment = async (req, res, next) => {
    try {
        ...
        const payment = await initiatePaymentService(req.user.id, gateway || 'easebuzz', Number(amount), currency || 'INR', { purpose, planId, ...(metadata || {}) });
