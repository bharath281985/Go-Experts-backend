...
export const getDashboard = async (req, res, next) => {
    try {
        ...
        const [clientProfile, activeProjects, draftProjects, completedProjects, pendingProposals, activeContracts, unreadNotifications, upcomingMeetings, totalSpendWallet, completion,] = await Promise.all([
        ...
        return res.json(successResponse('Client dashboard retrieved', {
