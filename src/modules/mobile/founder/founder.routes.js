...
import { listProposals, listProjectProposals, getProposal, acceptProposal, rejectProposal } from './controllers/proposals.controller.js';
...
router.get('/proposals/:id/accept', acceptProposal);
...
router.get('/proposals/:id/reject', rejectProposal);
