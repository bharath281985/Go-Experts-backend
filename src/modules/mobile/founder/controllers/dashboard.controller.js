...
export const getDashboard = async (req, res, next) => {
    try {
        ...
        const [founderProfile, subscription, wallet, pendingRequests, activeInvestors, unreadNotifications, upcomingMeetings, recommendedInvestors, completion,] = await Promise.all([
        ...
        return res.json(successResponse('Founder dashboard retrieved', {
            ...
            widgets: {
                ...
                recentActivities: [],
                recentDocuments: [],
                aiSuggestions: 'Optimize your pitch deck to focus more on your monetization strategy based on similar successful startups.',
