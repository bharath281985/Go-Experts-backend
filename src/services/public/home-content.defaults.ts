export const DEFAULT_HOME_CONTENT = {
  heroSlides: [
    {
      ...
      primary: { label: "Join as Freelancer", to: "/signup" },
    ...
    },
    {
      ...
      primary: { label: "Post a Project", to: "/post-project" },
    ...
    },
    {
      ...
      primary: { label: "Explore Investments", to: "/investors" },
    ...
    },
    {
      ...
      primary: { label: "Submit Startup Idea", to: "/founders" },
  ...
  roles: [
    ...
    { key: "client", icon: "Briefcase", title: "Client / Business", desc: "Post a project, hire matched experts, ship faster.", cta: "Post a Project", to: "/post-project" },
