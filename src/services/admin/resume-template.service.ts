...
import { RESUME_RENDERERS, VALID_RENDERER_KEYS } from '../../constants/resume-renderers';
    ...
    return prisma.$transaction(async (tx) => {
      ...
      await tx.resumeTemplateVersion.create({
        data: {
          ...
          supportedSections: rendererCaps.supportedSections,
          themeConfig: {},
          atsFriendly: false
        }
      });
    ...
    return prisma.$transaction(async (tx) => {
      ...
      const newVersion = await tx.resumeTemplateVersion.create({
        data: {
          ...
          supportedSections: versionData.supportedSections || [],
          themeConfig: versionData.themeConfig || {},
