  ...
  recommendation_tabs: {
    freelancer: [
      {
        ...
        label: "Projects",
        title: "Projects",
        subtitle: "Matched freelance projects",
      ...
      },
      {
        ...
        label: "Clients",
        title: "Clients",
        subtitle: "High-intent clients",
        description: "See clients actively hiring in your domain and budget range.",
    ...
    client: [
      ...
      },
      {
        ...
        label: "Projects",
        title: "Projects",
        subtitle: "Active workstreams",
        description: "Open projects and delivery priorities that need attention now.",
    ...
    investor: [
      ...
      },
      {
        ...
        description: "Review ambitious founders who are actively raising and building.",
        icon: "person_outline",
        accent: "#0F766E",
      },
      {
    ...
    founder: [
      ...
      },
      {
        ...
        description: "See potential customers, partners, and early commercial leads.",
        icon: "groups_outlined",
        accent: "#7C3AED",
      },
    ],
